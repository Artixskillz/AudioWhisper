...
class StdoutRedirector:
    ...
    def write(self, message):
        # Filter out empty newlines to keep log clean
        if message.strip():
...
class AudioWhisperApp(ctk.CTk):
    def __init__(self):
        ...
        # Window Setup
        self.title("AudioWhisper v3.0 (Real-Time)")
        ...
        self.show_timestamps = ctk.BooleanVar(value=True) # Default to True for v3
    ...
    def create_widgets(self):
        ...
        # Note: In v3, we always show timestamps in the log because verbose=True enforces it.
        # This switch now controls the *file output* format.
    ...
    def run_transcription(self):
        ...
        try:
            ...
            self.log("Starting transcription (Real-Time Mode)...")
            
            # Transcribe with verbose=True to print segments to stdout
            # We capture these prints via StdoutRedirector
            result = model.transcribe(process_file, verbose=True, fp16=False)
